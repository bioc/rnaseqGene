...
# Appendix: Some operational details

## Acquiring the airway FASTQ files
...
## Building the transcript index for salmon
...
## Producing transcript quantifications
...
```
I note that the FTP query failed on first attempt with a 421 "service not
available" error.  The second attempt, after a few minutes, succeeded.
